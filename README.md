...
**風呂タブ** — 浴槽なしの「風呂」と浴槽ありの「風呂（浴槽付き）」を、20 分刻みで予約する。朝は 06:00 から 08:00、夜は 19:00 から 24:00。予約できるのは今日と明日の枠で、1 人が持てるのは同じ日の朝に 1 枠、夜に 1 枠まで。取り消しはいつでもできる。
...
枠の刻み幅は `SLOT_MINUTES`、朝と夜の時間帯は `SECTION_HOURS`、投票の受付窓は `VOTE_WINDOW` にある。
